      ...
      <div className="max-w-3xl mx-auto relative z-10 py-12 px-4">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-cyan-500/50 shadow-lg hover:shadow-cyan-500/50 transition flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900">
              <img
                src="/logo.png"
